...
gulp.task('copy:data', function() {
  return gulp.src(['src/app/data/*'])
    .pipe(gulp.dest('dev/app/data'))
});

// copy framework and relevant vendor files
...
// copy everything except framework (which only should be done once, after clean)
gulp.task('copy:all', ['copy:html', 'copy:templates', 'copy:css', 'copy:assets', 'copy:data']);
